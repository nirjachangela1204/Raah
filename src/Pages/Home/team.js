  ...
  const [teamData, setTeamData] = useState([]);
    ...
    useEffect(() => {
        ...
        const fetchTeamData = async () => {
            try{
                const response = await axios.get('https://backend-m72h.onrender.com/fetchteam');
        ...
        <>
            <div class="col-lg-4 team-block-one">
                <div class="inner-box wow fadeInDown" data-wow-delay="200ms">
                    <div class="image"><a href="#"><img src={`https://backend-m72h.onrender.com/images/${props.image}`} alt=""/></a></div>
