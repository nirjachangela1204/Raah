...
function Event() {
    ...
    useEffect(() => {
        ...
        const fetchEventData = async () => {
            try{
                const response = await axios.get('https://backend-m72h.onrender.com/fetchevent');
    ...
    return (
        <div className="event-block-one">
            <div className="inner-box">
                <div className="image"><img src={`https://backend-m72h.onrender.com/images/${props.image}`} alt=""/></div>
