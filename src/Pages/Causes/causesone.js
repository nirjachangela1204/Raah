...
function CausesOne() {
    ...
    useEffect(() => {
        ...
        const fetchCausesData = async () => {
            try{
                const response = await axios.get('https://backend-m72h.onrender.com/fetchcauses');
        ...
        <>
         <div className="cause-block-four style-two col-lg-4 col-md-6">
            <div className="inner-box">
                <div className="image">
                    <img src={`https://backend-m72h.onrender.com/images/${props.image}`} style={{innerWidth: '200px', height: '200px'}} alt="" />
